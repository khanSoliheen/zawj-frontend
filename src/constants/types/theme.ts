...
export interface ThemeColors {
  ...
  checkbox: LinearGradientProps['colors'];
...
export interface ThemeGradients {
  primary?: LinearGradientProps['colors'];
  secondary?: LinearGradientProps['colors'];
  tertiary?: LinearGradientProps['colors'];
  black?: LinearGradientProps['colors'];
  white?: LinearGradientProps['colors'];
  light?: LinearGradientProps['colors'];
  dark?: LinearGradientProps['colors'];
  gray?: LinearGradientProps['colors'];
  danger?: LinearGradientProps['colors'];
  warning?: LinearGradientProps['colors'];
  success?: LinearGradientProps['colors'];
  info?: LinearGradientProps['colors'];
  divider?: LinearGradientProps['colors'];
  menu?: LinearGradientProps['colors'];
}
...
export interface ThemeAssets {
  OpenSansLight?: number;
  OpenSansRegular?: number;
  OpenSansSemiBold?: number;
  OpenSansExtraBold?: number;
  OpenSansBold?: number;
  ...
  avatarFemale: ImageSourcePropType;
  avatarMale: ImageSourcePropType;
